...
sFileName = r'C:\Users\Rohsn Chimbaikar\PycharmProjects\Data-Science-Practice\raw\IP_DATA_ALL.csv'

print('Loading:', sFileName)

# Define the output file path directly
sFileName2 = r'C:\Users\Rohsn Chimbaikar\PycharmProjects\Data-Science-Practice\processedata\Retrieve_IP_DATA.csv'
...
IP_DATA_ALL_FIX.columns = [col.strip().replace(" ", ".") for
                           col in IP_DATA_ALL_FIX.columns]
